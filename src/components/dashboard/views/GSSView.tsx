import { Gauge, Brain, Target, Timer, CalendarCheck, TrendingUp, Trophy, Zap, Award } from 'lucide-react';
import { Donut, RadarChart, Sparkline } from '@/components/dashboard/Charts';
