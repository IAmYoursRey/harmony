      ...
      <div className="section-container">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-10">
          ...
          <div className="text-center lg:text-left">
            ...
            >
              Platform pembelajaran kebencanaan berbasis Artificial Intelligence (AI),
              Digital Twin, dan Data Geospasial yang mendukung peningkatan literasi
              kebencanaan, kesiapsiagaan peserta didik, serta implementasi Program Satuan
            ...
            >
              <div className="glass inline-flex items-center gap-2 rounded-2xl px-4 py-3 text-left shadow-glass">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-ink-900 dark:text-white">{t('landing.chips.school_score.value')}</p>
                </div>
              </div>
            </motion.div>
            <motion.div
            ...
            >
              <div className="glass inline-flex items-center gap-2 rounded-2xl px-4 py-3 text-left shadow-glass">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-ink-900 dark:text-white">{t('landing.chips.live_data.value')}</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
        ...
        >
          {featureCards.map((c) => (
            ...
            >
              ...
              <h3 className="mt-4 font-display text-base font-bold text-ink-900 dark:text-white">{c.title === 'AI Learning Engine' ? 'Mesin Pembelajaran AI' : c.title === 'GeoSpatial Risk Mapping' ? 'Pemetaan Risiko Geo' : c.title === 'Digital Twin School' ? 'Kembaran Digital Sekolah' : 'Indeks Kesiapan Pintar'}</h3>
              <p className="mt-2 text-sm leading-relaxed text-ink-600 dark:text-slate-300">{c.description}</p>
