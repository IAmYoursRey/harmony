...
const socials = [
  {
    icon: Instagram,
    label: "Instagram",
    href: "https://instagram.com/geosense.edu",
  },
  {
    icon: Linkedin,
    label: "LinkedIn",
    href: "https://linkedin.com/company/geosense-edu",
  },
...
export function Footer() {
  ...
  return (
    <footer
      id="contact"
      className="relative overflow-hidden bg-ink-900 text-ink-300 dark:bg-black"
    >
      ...
      <div className="section-container relative py-14 sm:py-16">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-5 space-y-2.5 text-sm">
              ...
              <p className="flex items-center gap-2 text-ink-400">
                <MapPin className="h-4 w-4 text-brand-400" /> SMA Negeri 1
                Ngoro, Mojokerto, East Java, Indonesia
              </p>
            </div>
          </div>
        ...
        <div className="mt-6 flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-6 sm:flex-row">
          <p className="flex items-center gap-1.5 text-xs text-ink-500">
            <Info className="h-3.5 w-3.5" />© 2026 GeoSense Edu. All Rights
            Reserved.
          </p>
