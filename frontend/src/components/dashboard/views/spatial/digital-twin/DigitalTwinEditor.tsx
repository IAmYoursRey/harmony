    ...
    <div className="space-y-6">
      <div className="glass rounded-2xl p-5 transition-all hover:shadow-glass dark:bg-slate-900/60 h-auto">
        ...
        <div className="mt-6 pt-4 border-t border-slate-100 dark:border-slate-800 text-xs text-ink-500 leading-relaxed">
          {activeTool === "select" &&
            "Klik dan tahan titik untuk memindahkannya."}
          {activeTool === "waypoint" &&
            "Klik pada area peta untuk menambah titik kumpul/jalan."}
          {activeTool === "exit" &&
            "Klik pada peta untuk menentukan area aman/luar sekolah."}
          {activeTool === "path" &&
            "Klik Titik A lalu klik Titik B untuk membuat garis jalur evakuasi."}
          {activeTool === "delete" &&
            "Klik pada titik atau garis untuk menghapusnya."}
        </div>
      </div>
      ...
      <div className="glass rounded-2xl p-5 transition-all hover:shadow-glass dark:bg-slate-900/60 h-auto">
        ...
        <div className="text-xs text-ink-500 bg-brand-50 p-4 rounded-lg leading-relaxed mt-4">
          <p className="mb-2">
            <strong>Pastikan Peta Anda:</strong>
          </p>
          ...
          <p className="mt-4 text-brand-600 font-bold">
            Tekan tombol{" "}
            <span className="px-2 py-1 bg-brand-600 text-white rounded">
              Simpan Pembaruan
            </span>{" "}
            untuk mematikan mode edit dan mencoba Simulasi.
          </p>
        </div>
      </div>
    </div>
