...
const TOOLS = [
  {
    ...
    desc: "Struktur permanen yang memblokir pergerakan",
  },
  {
    id: "EMPTY",
    label: "Kosong",
    Icon: Layout,
    color: "bg-white text-slate-500",
    borderColor: "border-slate-300",
    desc: "Area default/kosong",
  },
  {
    id: "ROOM",
    label: "Ruangan",
    ...
    desc: "Tandai area sebagai ruang kelas/fasilitas",
  },
  {
    id: "CORRIDOR",
    label: "Koridor",
  ...
  },
  {
    ...
    desc: "Titik akses masuk/keluar ruangan",
  },
  {
    id: "SAFE_POINT",
    label: "Titik Aman",
    ...
    desc: "Target zona aman evakuasi",
  },
  {
    id: "SPAWN",
    label: "Titik Mulai",
    ...
    desc: "Posisi awal saat simulasi dimulai",
  },
  {
    id: "HAZARD",
    label: "Bahaya",
    ...
    desc: "Tandai area bahaya (hazard zone)",
  },
  {
    id: "ERASE",
    label: "Hapus",
    ...
    borderColor: "border-slate-300",
    desc: "Hapus sel kembali menjadi kosong",
  },
] as const;
