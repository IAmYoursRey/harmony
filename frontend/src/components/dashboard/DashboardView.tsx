          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-brand-200">
                {currentUser?.role === 'dev' ? t('role.dev') : currentUser?.role === 'teacher' ? t('role.teacher') : t('role.student')} &bull; {currentProfile?.schoolId && currentProfile.schoolId !== 'unknown' ? (selection?.school?.name || currentProfile.schoolId) : t('school.unknown', 'Belum Memilih Sekolah')}
              </p>
