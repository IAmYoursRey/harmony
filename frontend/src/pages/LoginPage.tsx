...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (!loginEmail || !loginPassword) {
      show("Mohon isi email dan kata sandi.", "error");
      return;
    }
    setLoading(true);
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    if (
      ...
      !regPassword ||
      !regGrade ||
      (role === "student" && !regSection)
    ) {
      show("Mohon lengkapi semua data yang wajib diisi.", "error");
      return;
    }
    if (regPassword !== regConfirm) {
      show("Konfirmasi kata sandi tidak sesuai.", "error");
      return;
    }
    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-slate-50 dark:bg-slate-950 px-4 py-10">
      ...
      <div className="w-full max-w-md">
          ...
          <AnimatePresence mode="wait">
            ...
            {mode === "role-select" && (
              <motion.div
                ...
                className="mt-7"
              >
                <p className="mb-4 text-center text-sm font-medium text-ink-500 dark:text-slate-400">
                ...
                <div className="grid gap-3">
                  {(
                    ...
                    <div
                      key={r}
                      className={`grid gap-2 ${r === "teacher" ? "grid-cols-1" : "grid-cols-2"}`}
                    >
                      <button
                        onClick={() => handleRoleSelect(r, "login")}
                      ...
                      >
                        ...
                        <div>
                          ...
                          <p className="text-[11px] text-ink-400 dark:text-slate-400 flex items-center gap-1">
                      ...
                      {r === "student" && (
                        <button
                          onClick={() => handleRoleSelect(r, "register")}
                        ...
                        >
                          ...
                          <div>
                            ...
                            <p className="text-[11px] text-ink-400 dark:text-slate-400 flex items-center gap-1">
                              <UserPlus className="h-3 w-3" /> Daftar
                            </p>
                          </div>
                        </button>
                      )}
                      <p
                        className={`${r === "teacher" ? "col-span-1" : "col-span-2"} -mt-1 text-center text-[10px] text-ink-400`}
                      >
                        {desc}
                      </p>
                    </div>
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <button
                    ...
                    className="text-sm text-ink-500 hover:text-ink-900 dark:text-slate-400 flex items-center gap-1"
                  >
            ...
            {mode === "register" && (
              ...
              >
                ...
                <div className="space-y-1">
                  ...
                  >
                    Tanggal Lahir{" "}
                    <span className="text-ink-400 font-normal">(opsional)</span>
                  </label>
                  <div className="relative">
        ...
        <div className="mt-6 flex items-center justify-center gap-4 text-xs text-ink-400 dark:text-slate-500">
          ...
          <span className="flex items-center gap-1.5">
            <Satellite className="h-3.5 w-3.5" /> Geospasial
          </span>
          <span className="flex items-center gap-1.5">
            <ShieldCheck className="h-3.5 w-3.5" /> SPAB
          </span>
        </div>
      </div>
    </div>
