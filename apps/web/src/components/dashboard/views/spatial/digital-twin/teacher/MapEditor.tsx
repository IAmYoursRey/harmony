    ...
    (x: number, y: number) => {
      ...
      setCells((prev) => {
        ...
        if (cellType === "SAFE_POINT") {
          ...
          setSpawnPoints([
            { id: `spawn_${x}_${y}`, name: "Titik Mulai", x, y },
          ]);
          ...
          setDoors((drs) => {
            ...
            return [
              ...drs,
              { id: `door_${x}_${y}`, x, y, state: "open", breakable: false },
            ];
          });
        }
  ...
  return (
    <div className="space-y-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-ink-500">
              ...
              {map.cellScale} {map.cellScaleUnit} &bull; Area: {realW}×{realH}{" "}
              {map.cellScaleUnit} &bull; {cellCount} sel diedit
            </p>
          </div>
        </div>
        <button
      ...
      <div className="text-xs text-ink-500 flex items-center gap-1.5 bg-blue-50 dark:bg-blue-950/30 rounded-lg px-3 py-2">
        ...
        Klik sel untuk mengecat. Klik dan tahan untuk mengecat banyak sel
        sekaligus. Pilih alat di toolbar.
      </div>
