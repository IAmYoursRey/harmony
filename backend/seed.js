...
const PASSWORD_HASH = db.accounts.find(a => a.email === 'alvira.nizha@geosense.edu').passwordHash;
...
// 2. Create Students
const studentsData = [
  { id: 'usr-s1', name: 'Budi Santoso', email: 'budi@student.geosense.edu', classId: classA.id },
  { id: 'usr-s2', name: 'Siti Aminah', email: 'siti@student.geosense.edu', classId: classA.id },
  { id: 'usr-s3', name: 'Ahmad Fauzi', email: 'ahmad@student.geosense.edu', classId: classA.id },
  { id: 'usr-s4', name: 'Rina Wijaya', email: 'rina@student.geosense.edu', classId: classB.id }
];
